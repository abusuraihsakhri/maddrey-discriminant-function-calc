"""
FastAPI REST API Server for Maddrey Discriminant Function Calc.
"""
...
app = FastAPI(
    title="Maddrey Discriminant Function Calc API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "maddrey-discriminant-function-calc", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
