"""
Live WebSocket Distributed Component Telemetry Streamer for maddrey-discriminant-function-calc.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "maddrey-discriminant-function-calc", "event_type": event_type, "payload": data})
