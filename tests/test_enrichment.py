"""
Automated Pytest for maddrey-discriminant-function-calc Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MaddreydiscriminantfunctioncalcEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MaddreydiscriminantfunctioncalcEnrichmentSuite()
